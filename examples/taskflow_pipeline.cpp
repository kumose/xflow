...
void make_taskflow1(xf::Taskflow& tf) {
...
void make_taskflow2(xf::Taskflow& tf) {
...
void make_taskflow3(xf::Taskflow& tf) {
...
int main() {
  ...
  xf::Taskflow taskflow("taskflow processing pipeline");
  ...
  std::array<xf::Taskflow, num_pipes> taskflows;
