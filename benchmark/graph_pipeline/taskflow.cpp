...
std::chrono::microseconds graph_pipeline_taskflow_1_pipe(
  ...
  xf::Pipeline pl(num_lines,
    xf::Pipe{xf::PipeType::SERIAL, Input{0, 0, mybuffer, graph}} // 1st pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_2_pipes(
  ...
  xf::Pipeline pl(num_lines,
    xf::Pipe{xf::PipeType::SERIAL, Input{0, 0, mybuffer, graph}}, // 1st pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 2nd pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_3_pipes(
  ...
  xf::Pipeline pl(num_lines,
    xf::Pipe{xf::PipeType::SERIAL, Input{0, 0, mybuffer, graph}}, // 1st pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 2nd pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 3rd pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_4_pipes(
  ...
  xf::Pipeline pl(num_lines,
    xf::Pipe{xf::PipeType::SERIAL, Input{0, 0, mybuffer, graph}}, // 1st pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 2nd pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 3rd pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 4th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_5_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 2nd pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 3rd pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 4th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 5th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_6_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 3rd pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 4th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 5th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 6th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_7_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 4th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 5th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 6th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 7th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_8_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 5th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 6th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 7th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 8th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_9_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 6th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 7th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 8th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 9th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_10_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 7th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 8th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 9th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 10th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_11_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 8th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 9th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 10th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 11th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_12_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 9th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 10th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 11th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 12th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_13_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 10th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 11th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 12th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 13th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_14_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 11th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 12th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 13th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 14th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_15_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 12th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 13th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 14th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 15th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_16_pipes(
  ...
  xf::Pipeline pl(num_lines,
    ...
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 13th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 14th pipe
    xf::Pipe{xf::PipeType::SERIAL, Filter{mybuffer, graph}},      // 15th pipe
    xf::Pipe{xf::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 16th pipe
  );
