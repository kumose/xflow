...
namespace xf {
    ...
    */
    ...
    to schedule parallel iterations (e.g., xf::Taskflow::for_each).

    An partitioner defines the scheduling method for running parallel algorithms,
    such xf::Taskflow::for_each, xf::Taskflow::reduce, and so on.
    By default, we provide the following partitioners:

    + xf::GuidedPartitioner  to enable guided scheduling algorithm of adaptive chunk size
    + xf::DynamicPartitioner to enable dynamic scheduling algorithm of equal chunk size
    + xf::StaticPartitioner  to enable static scheduling algorithm of static chunk size
    + xf::RandomPartitioner  to enable random scheduling algorithm of random chunk size
    ...
    iteration, xf::StaticPartitioner can deliver the best performance.
    On the other hand, if the work unit per iteration is irregular and unbalanced,
    xf::GuidedPartitioner or xf::DynamicPartitioner can outperform xf::StaticPartitioner.
    In most situations, xf::GuidedPartitioner can deliver decent performance and
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xf::StaticPartitioner(0, [](auto&& closure){
    ...
    @attention
    The default closure wrapper (xf::DefaultClosureWrapper) does nothing but invoke
    ...
    */
    ...
    public:
        ...
        */
        PartitionerBase(size_t chunk_size, C &&closure_wrapper) : _chunk_size{chunk_size},
    ...
    @tparam C closure wrapper type (default xf::DefaultClosureWrapper)
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xf::GuidedPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    public:
        ...
        */
        explicit GuidedPartitioner(size_t sz, C &&closure) : PartitionerBase<C>(sz, std::forward<C>(closure)) {
        }
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xf::DynamicPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    public:
        ...
        */
        explicit DynamicPartitioner(size_t sz, C &&closure) : PartitionerBase<C>(sz, std::forward<C>(closure)) {
        }
    ...
    */
    ...
    public:
        ...
        */
        explicit StaticPartitioner(size_t sz, C &&closure) : PartitionerBase<C>(sz, std::forward<C>(closure)) {
        }
    ...
    Similar to xf::DynamicPartitioner,
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xf::RandomPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    public:
        ...
        */
        explicit RandomPartitioner(size_t sz, C &&closure) : PartitionerBase<C>(sz, std::forward<C>(closure)) {
        }
        ...
        */
        RandomPartitioner(float alpha, float beta, C &&closure) : _alpha{alpha}, _beta{beta},
    ...
    /**
    @brief default partitioner set to xf::GuidedPartitioner
    ...
    */
    ...
    A partitioner is a derived type from xf::PartitionerBase.
    */
    template<typename P>
