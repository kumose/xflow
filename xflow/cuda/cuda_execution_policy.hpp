...
#include <xflow/cuda/cuda_error.hpp>
...
class cudaExecutionPolicy {
  ...
  */
  ...
  The function is used to allocate a buffer for calling xf::cuda_reduce,
  xf::cuda_uninitialized_reduce, xf::cuda_transform_reduce, and
  xf::cuda_uninitialized_transform_reduce.
  */
  template <typename T>
  static unsigned reduce_bufsz(unsigned count);

  /**
  @brief queries the buffer size in bytes needed to call xf::cuda_min_element
  ...
  */
  ...
  /**
  @brief queries the buffer size in bytes needed to call xf::cuda_max_element
  ...
  */
  ...
  xf::cuda_inclusive_scan, xf::cuda_exclusive_scan,
  xf::cuda_transform_inclusive_scan, and xf::cuda_transform_exclusive_scan.
  */
  template <typename T>
  ...
  The function is used to allocate a buffer for calling
  xf::cuda_merge and xf::cuda_merge_by_key.
  */
