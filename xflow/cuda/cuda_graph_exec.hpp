...
class cudaGraphExecBase : public std::unique_ptr<std::remove_pointer_t<cudaGraphExec_t>, Deleter> {
  ...
  */
  ...
  This method updates the parameter of the given host task (similar to xf::cudaFlow::host).
  */
  template <typename C>
  ...
  The method is similar to xf::cudaFlow::kernel but operates on a task
  of type xf::cudaTaskType::KERNEL.
  ...
  */
  ...
  The method is similar to xf::cudaFlow::memset but operates on a task
  of type xf::cudaTaskType::MEMSET.
  ...
  */
  ...
  The method is similar to xf::cudaFlow::memcpy but operates on a task
  of type xf::cudaTaskType::MEMCPY.
  The source/destination memory may have different address values but
  must be allocated from the same contexts as the original
  source/destination memory.
  */
  ...
  The method is similar to xf::cudaFlow::zero but operates on
  a task of type xf::cudaTaskType::MEMSET.
  ...
  */
  ...
  The method is similar to xf::cudaFlow::fill but operates on a task
  of type xf::cudaTaskType::MEMSET.
  ...
  */
  ...
  The method is similar to xf::cudaFlow::copy but operates on a task
  of type xf::cudaTaskType::MEMCPY.
  The source/destination memory may have different address values but
  must be allocated from the same contexts as the original
  source/destination memory.
