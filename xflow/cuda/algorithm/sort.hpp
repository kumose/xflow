...
@tparam K key type
@tparam V value type (default xf::cudaEmpty)

@param count number of keys/values to sort

The function is used to allocate a buffer for calling xf::cuda_sort.
...
This method is equivalent to xf::cuda_sort_by_key without values.
