...
#include <xflow/core/atomic_notifier.hpp>
#include <xflow/core/nonblocking_notifier.hpp>
...
namespace xf {
    ...
    */
    ...
    from an observer derived from xf::ObserverInterface.
    */
    class WorkerView {
        friend class Executor;
    ...
    The xf::WorkerInterface class allows users to customize worker properties when creating an executor.
    ...
    @attention
    xf::WorkerInterface::scheduler_prologue and xf::WorkerInterface::scheduler_eiplogue
    ...
    */
    ...
    /**
    @brief helper function to create an instance derived from xf::WorkerInterface

    @tparam T type derived from xf::WorkerInterface
