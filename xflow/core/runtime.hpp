...
#include <xflow/core/executor.hpp>
...
namespace xf {
    ...
    xf::Task A = taskflow.emplace([&](xf::Runtime& rt){
    ...
    */
    ...
    public:
        ...
        */
        ...
        std::tie(A, B, C, D) = taskflow.emplace(
          [] () { return 0; },
          [&C] (xf::Runtime& rt) {  // C must be captured by reference
            std::cout << "B\n";
            rt.schedule(C);
          },
          [] () { std::cout << "C\n"; },
        ...
        */
        ...
        Unlike xf::Executor::async, the task created here is bound to the runtime object and
        is implicitly synchronized at the end of the runtime's scope.
        Applications may also call xf::Runtime::corun explicitly to wait for all
        ...
        */
        ...
        Similar to xf::Runtime::async, but takes a parameter of type xf::TaskParams to initialize
        ...
        */
        ...
        This function is more efficient than xf::Runtime::async and is recommended when the result
        ...
        */
        ...
        Similar to xf::Runtime::silent_async, but takes a parameter of type xf::TaskParams to initialize
        the created asynchronous task.
        ...
        */
        ...
        This member function is more efficient than xf::Runtime::dependent_async
        ...
        @code{.cpp}
        taskflow.emplace([](xf::Runtime& rt){
          xf::AsyncTask A = rt.silent_dependent_async([](){ printf("A\n"); });
          xf::AsyncTask B = rt.silent_dependent_async([](){ printf("B\n"); });
        ...
        */
        ...
        @code{.cpp}
        taskflow.emplace([](xf::Runtime& rt){
          xf::AsyncTask A = rt.silent_dependent_async("A", [](){ printf("A\n"); });
          xf::AsyncTask B = rt.silent_dependent_async("B", [](){ printf("B\n"); });
        ...
        */
        ...
        returned by xf::Runtime::dependent_async and xf::Runtime::silent_dependent_async
        ...
        */
        ...
        You can mix the use of xf::AsyncTask handles
        returned by xf::Runtime::dependent_async and rt::Runtime::silent_dependent_async
        when specifying task dependencies.
        */
        template<typename F, typename I,
            std::enable_if_t<!std::is_same_v<std::decay_t<I>, AsyncTask>, void>* = nullptr
        ...
        */
        ...
        /**
        @brief equivalent to xf::Runtime::corun - just an alias for legacy purpose
        */
        void corun_all();
    ...
    // constructor
    inline Runtime::Runtime(Executor &executor, Worker &worker, Node *parent) : _executor{executor},
        _worker{worker},
        _parent{parent} {
    }
    ...
    >
    xf::AsyncTask Runtime::silent_dependent_async(F &&func, Tasks &&... tasks) {
    ...
    >
    xf::AsyncTask Runtime::silent_dependent_async(
    ...
    >
    xf::AsyncTask Runtime::silent_dependent_async(F &&func, I first, I last) {
    ...
    */
    ...
    private:
        ...
        @private
        */
        explicit NonpreemptiveRuntime(Executor &executor, Worker &worker) : _executor{executor}, _worker{worker} {
        }
    ...
    inline void Executor::_invoke_nonpreemptive_runtime_task(Worker &worker, Node *node) {
        _observer_prologue(worker, node);
        xf::NonpreemptiveRuntime nprt(*this, worker);
        TF_EXECUTOR_EXCEPTION_HANDLER(worker, node, {
