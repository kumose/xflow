...
#include <xflow/utility/macros.hpp>
...
#include <xflow/utility/serializer.hpp>
#include <xflow/utility/lazy_string.hpp>
#include <xflow/core/error.hpp>
#include <xflow/core/declarations.hpp>
#include <xflow/core/semaphore.hpp>
#include <xflow/core/environment.hpp>
#include <xflow/core/topology.hpp>
#include <xflow/core/tsq.hpp>
...
namespace xf {
    ...
    */
    class Node {
        ...
        struct Runtime {
            ...
            std::function<void(xf::Runtime &)> work;
        };
        ...
        struct NonpreemptiveRuntime {
            ...
            std::function<void(xf::NonpreemptiveRuntime &)> work;
        };
        ...
        struct Subflow {
            ...
            std::function<void(xf::Subflow &)> work;
            Graph subgraph;
        };
        ...
        struct Async {
            ...
            std::variant<
                std::function<void()>,
                std::function<void(xf::Runtime &)>, // silent async
                std::function<void(xf::Runtime &, bool)> // async
            > work;
        };
    ...
    */
     ...
     * with the exact signature `xf::Graph& graph()`. It uses SFINAE and `std::void_t`
     * to detect the presence of the member function and its return type.
     *
     * @tparam T The type to inspect.
     * @retval true If the type `T` has a member function `xf::Graph& graph()`.
     ...
     *
     * struct A {
     *   xf::Graph& graph() { return my_graph; };
     *   xf::Graph my_graph;
     *
