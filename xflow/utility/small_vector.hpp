...
namespace xf {
    ...
    */
    ...
    void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
        ...
        size_t NewCapacity = size_t(xf::detail::NextCapacity(CurCapacity + 2));
    ...
    */
    ...
    public:
        ...
        */
        ...
        //explicit SmallVector(const xf::iterator_range<RangeTy> &R)
        //    : SmallVectorImpl<T>(N) {
...
namespace std {
    ...
    template<typename T>
    inline void
    swap(xf::SmallVectorImpl<T> &LHS, xf::SmallVectorImpl<T> &RHS) {
        LHS.swap(RHS);
    }
    ...
    template<typename T, unsigned N>
    inline void
    swap(xf::SmallVector<T, N> &LHS, xf::SmallVector<T, N> &RHS) {
        LHS.swap(RHS);
    }
